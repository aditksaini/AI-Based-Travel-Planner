        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400 font-inter">
              Sign in to continue planning your next intelligent journey.
            </p>
          </div>
          ...
          <div className="glass rounded-2xl p-8 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center space-x-3 py-4 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-white/20 transition-all text-sm font-semibold text-slate-300 hover:text-white cursor-pointer group/social"
              >
